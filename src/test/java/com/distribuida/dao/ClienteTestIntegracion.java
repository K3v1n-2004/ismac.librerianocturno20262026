...
@Test
    public void update(){
        Optional<Cliente> cliente = clienteDAO.findById(48);
...
@Test
    public void delete (){
        if (clienteDAO.existsById(48)){
            clienteDAO.deleteById(48);
        }
        assertFalse(clienteDAO.existsById(48), "El id=44 deberia haberse eliminado");
}
